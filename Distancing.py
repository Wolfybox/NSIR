...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_name', default=r'Distancing', help='name of log of current simulation')
    ...
    parser.add_argument('--max_time', type=int, default=300, help='maximum duration of simulation')
    parser.add_argument('--dtc_start', type=int, default=30, help='starting point of distancing policy')
    parser.add_argument('--dtc_duration', type=int, default=30, help='duration of distancing policy')
    ...
    dtc_start = config.dtc_start
    dtc_duration = config.dtc_duration
    dtc_end = dtc_start + dtc_duration
    ...
    log_name = f'{config.log_name}_start{dtc_start}_duration{dtc_duration}.txt'
    log_lines = []
    t_cur = 0
    p, dtc_p, nor_p = None, 0.0, 0.5
    while t_cur < t_max:
        distancing_flag = (dtc_start < t_cur < dtc_end)
        p = dtc_p if distancing_flag else nor_p
